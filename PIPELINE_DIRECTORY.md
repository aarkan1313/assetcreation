...
- **2026-05-07 (evening)** — Phase B complete (B.1–B.5): SR→bake→mip→per-tier QA pipeline wired into `aaa_texture.py --ladder`. Phase D complete: temperate_forest + grassland kits generated (10 new wgv3_tf_*/wgv3_gl_* textures); `biome_kits.json` updated; all 5 kits now have purpose-built materials.
...
- **Roadmap:** `world3/docs/ROADMAP.md` — Phase B done, Phase D done; Phase C (iso/topdown scale) is next.
