...
| R4 | Source-material repair | Active | Organic repair candidates exist, but remain quarantined after runtime review showed detail/normal risk. |
...
runtime material path toward the OpenTopo stack model:

- Real or source-derived macro color anchors the terrain.
- Slope/height/material masks select broad terrain classes.
- Tileable generated materials provide close detail only where they are clean.
