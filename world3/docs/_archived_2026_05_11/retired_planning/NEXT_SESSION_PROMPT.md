...
M14 close-play terrain quality has started:
`world3/docs/M14_CLOSE_PLAY_QUALITY_BOARD_2026_05_10.md` is generated by
`world3/pipeline/build_m14_close_play_quality_board.py` from
`world3/jobs/m14_texture_bakeoff_plan.json` plus the M8 organic queue. It locks
the active model lanes to FLUX.2-klein, AuraFlow v0.3, and SD 3.5 Large;
