...
> ✅ **Still canonical 2026-05-11.** The six conditions in this doc
> define Phase I (the terminal phase) in the unified roadmap. Phases
> F, G, H are sized to close those conditions. This doc does not need
> a redirect — it is referenced *by* the unified roadmap, not
> superseded by it.
>
