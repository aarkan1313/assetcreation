...
func _run() -> void:
	...
	var metrics := {
		...
		"enable_transition_boundaries": bool(loader.get("enable_transition_boundaries")),
		"transition_rule_id": String(loader.get("transition_rule_id")),
		"transition_masks_built": int(loader.get("transition_masks_built")),
		"transition_mask_build_ms_total": float(loader.get("transition_mask_build_usec_total")) / 1000.0,
		"transition_mask_build_ms_max": float(loader.get("transition_mask_build_usec_max")) / 1000.0,
