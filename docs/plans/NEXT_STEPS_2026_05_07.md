...
| P5 | Phase 2: replace nvdiffrast with Hunyuan3D-Paint projection module if smearing unacceptable | 1-2 days | Deferred — gated on Phase 1 quality eval |
| P6 | Phase 3: Grounded-SAM-2 mask gen + damage-state parameterization | sub-day each | Deferred — Phase 1 uses hand-authored view masks |
