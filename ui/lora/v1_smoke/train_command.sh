#!/usr/bin/env bash
# LoRA train — run id v1_smoke
# Base model: black-forest-labs/FLUX.1-schnell
# Auto-written by pipelines/ui/lora_train.py at 2026-05-06T20:44:01+00:00
#
...
accelerate launch --num_cpu_threads_per_process 4 \
  ...
  --config_file 'D:/assets/ui/lora/v1_smoke/train_lora.toml'
